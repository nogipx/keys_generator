...
// SOURCE YAML - package:example/example_nodoc.keys.yml
...
class _ExampleNodocGroupKeys {
  const _ExampleNodocGroupKeys._();
  _ExampleNodocGroupListKeys get list => const _ExampleNodocGroupListKeys._();
}
